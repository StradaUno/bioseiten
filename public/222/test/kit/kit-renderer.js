...
import { createClient } from '/222/test/vendor/supabase-js.mjs'
...
const STR = {
  de: { contact:'Kontakt', contact_btn:'Kooperation anfragen', imprint:'Impressum',
    ...
    avg_views:'Ø Views', avg_comments:'Ø Kommentare',
  ...
  en: { contact:'Contact', contact_btn:'Request a collaboration', imprint:'Imprint',
    ...
    avg_views:'Avg views', avg_comments:'Avg comments',
  ...
  it: { contact:'Contatti', contact_btn:'Richiedi una collaborazione', imprint:'Impressum',
    ...
    avg_views:'Media views', avg_comments:'Media commenti',
...
const CSS = `
@import url('/222/test/fonts/fonts.css');
